...
export default function JacketSize({navigation, route}: PhotosAccessProps) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Header
        ...
        route={route}
      />
      <FontText style={styles.fav}> Jacket size ?</FontText>
      <View style={styles.size}>
        <FontText style={{fontWeight: '600', fontSize: 18}}>Jacket</FontText>
      </View>
      <View
        style={{
          alignSelf: 'center',
          ...
          onPress={() => {
            ...
            if (unique1.length > 0) {
              navigation.navigate('Confirm', {
                ...
                pantssize: route.params.pantssize,
                jacketsize: unique1,
              });
            } else {
