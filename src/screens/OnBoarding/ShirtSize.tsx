...
export default function ShirtSize({navigation, route}: PhotosAccessProps) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Header
        ...
        route={route}
      />
      <FontText style={styles.fav}> Shirt size ?</FontText>
      <View style={styles.size}>
        <FontText style={{fontWeight: '600', fontSize: 18}}>Shirts</FontText>
        <FontText
      ...
      <View style={styles.buttonContainer}>
        <Button
          ...
          onPress={() => {
            console.log('checkRoutes', JSON.stringify(route));
            ...
            console.log('Check array unique', unique1);
            if (unique1.length > 0) {
              navigation.navigate('PantsSize', {
